...
const TextStyle dropDownMenuItemStyle = TextStyle(color: Colors.black, fontSize: 17.0);
...
class _ChoiceChipState extends State<ChoiceChip> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: widget.selected ? BoxDecoration(color: Colors.white.withOpacity(0.2), borderRadius: BorderRadius.all(Radius.circular(30))) : null,
      child: Row(
        mainAxisSize: MainAxisSize.min,
...
List<CityCard> cityCards = [
  CityCard("assets/images/lasvegas.jpg", "Las Vegas", "Feb 2019", "45", "4,299", "2,250"),
  CityCard("assets/images/athens.jpg", "Las Vegas", "Feb 2019", "10", "4299", "2250"),
  CityCard("assets/images/sydney.jpeg", "Las Vegas", "Feb 2019", "60", "4299", "2250"),
  CityCard("assets/images/lasvegas.jpg", "Las Vegas", "Feb 2019", "30", "4299", "2250"),
  CityCard("assets/images/athens.jpg", "Las Vegas", "Feb 2019", "95", "4299", "2250"),
  CityCard("assets/images/sydney.jpeg", "Las Vegas", "Feb 2019", "80", "4299", "2250"),
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          Row(
            children: <Widget>[
              SizedBox(width: 5.0,),
              Text("$newPrice yen", style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold, fontSize: 14.0),),
              SizedBox(width: 5.0,),
              Text("($oldPrice yen)", style: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold, fontSize: 12.0),),
            ],
          )
        ],
      ),
